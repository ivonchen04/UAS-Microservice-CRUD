# Microservice-login
Microservice login adalah sebuah proyek microservice dengan REST API untuk login, CRUD tabel users, dan manajemen akses pengguna (role: admin, member) yang dibangun di atas Python dan Flask. Proyek ini dibuat untuk menyelesaikan proyek Ujian Akhir Semester Pemrograman PL SQL.
